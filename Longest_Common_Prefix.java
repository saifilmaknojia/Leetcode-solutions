...
class Longest_Common_Prefix {
    public String longestCommonPrefix(String[] strs) {
        ...
        // so, we sort the array first, now we know, the largest prefix possible is upto
        // the
        ...
        // first we check is abdef in abdgklmsn --> NO, then we remove last character
        // from shortest
        // next we check is abde in abdgklmsn --> NO, we remove last character from
        // shortest
